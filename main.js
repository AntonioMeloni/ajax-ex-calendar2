$(document).ready(function () {
    ...
    $('.mese-prec').click(function () {
         $('.mese-succ').prop('disabled', false); // Mese precedente
    ...
    function stampaGiorniMese(meseDaStampare) {
        ...
        var nDayWeek = meseDaStampare.isoWeekday();
        for (var i = 1; i < nDayWeek; i++) {
          var templateFinale = templateGiorno();
          $('#calendar').append(templateFinale);
        }
        console.log(nDayWeek);
